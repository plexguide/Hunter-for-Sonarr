const huntarrBlue = '#35c5f4';
const huntarrAlternateBlue = '#2193b5';
const darkGray = '#888';
...
const light = {
  ...
  themeBlue: huntarrBlue,
  themeAlternateBlue: huntarrAlternateBlue,
  themeRed: '#c4273c',
  ...
  // Header
  pageHeaderBackgroundColor: huntarrAlternateBlue,
